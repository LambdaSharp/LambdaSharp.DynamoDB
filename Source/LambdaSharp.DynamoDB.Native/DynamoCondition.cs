...
namespace LambdaSharp.DynamoDB.Native {
    ...
    public static class DynamoCondition {
        ...
        /// </summary>
        /// <param name="value">The item or item property to check for.</param>
        ...
        /// </summary>
        /// <param name="value">The item property to check.</param>
        ...
        /// </summary>
        /// <param name="set">The item property to check.</param>
        ...
        /// </summary>
        /// <param name="value">The item property to get the character count of.</param>
        ...
        /// </summary>
        /// <param name="value">The item property to get the byte size of.</param>
        ...
        /// </summary>
        /// <param name="set">The item property to get the set item count of.</param>
        ...
        /// </summary>
        /// <param name="list">The item property to get the list item count of.</param>
        ...
        /// </summary>
        /// <param name="map">The item property to get the map item count of.</param>
